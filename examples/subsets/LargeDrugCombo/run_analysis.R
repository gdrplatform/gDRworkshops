...
wd <- file.path(here::here(), "examples", "subsets", "LargeDrugCombo")
...
manifest <- file.path(wd, "manifest.xlsx")
treatment <- file.path(wd, "template.xlsx")
raw_data <- file.path(wd, list.files(wd, pattern = "mtx17\\.csv$"))
